...
class ManagerMixin(object):
    def _has_principal_difference(self, old_instance, new_instance, validation_fields):
        ...
        _unhashable_types = [list, dict]
        old_instance_data = old_instance.__dict__.copy()
        pop_keys = [
            i for i in old_instance_data.keys() if i.startswith('_') or type(old_instance_data[i]) in _unhashable_types
        ]
        ...
        pop_keys = [
            i for i in new_instance_data.keys() if i.startswith('_') or type(new_instance_data[i]) in _unhashable_types
        ]
